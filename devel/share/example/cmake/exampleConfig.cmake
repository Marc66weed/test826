...
if("TRUE" STREQUAL "TRUE")
  set(example_SOURCE_PREFIX /home/marc/test826/src/example)
  set(example_DEVEL_PREFIX /home/marc/test826/devel)
  set(example_INSTALL_PREFIX "")
  set(example_PREFIX ${example_DEVEL_PREFIX})
else()
  set(example_SOURCE_PREFIX "")
  set(example_DEVEL_PREFIX "")
  set(example_INSTALL_PREFIX /home/marc/test826/install)
...
if(NOT "/home/marc/test826/devel/include " STREQUAL " ")
  set(example_INCLUDE_DIRS "")
  set(_include_dirs "/home/marc/test826/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marc/test826/src/example/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/marc/test826/devel/lib;/home/marc/test826/devel/lib;/home/marc/catkin_ws/devel/lib;/opt/ros/melodic/lib)
